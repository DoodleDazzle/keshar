    ...
    <main>
      ...
      <SectionFrame>
        <div className="grid gap-5 md:grid-cols-2">
          <div className="aspect-[16/9] md:col-span-2">
            <div className="h-full overflow-hidden rounded-3xl bg-[#1a1a1a]">
              <PlaceholderImage src={gallery[0]} label={`${project.title} 1`} className="object-cover" />
            </div>
          </div>
        </div>
      </SectionFrame>
      ...
      <SectionFrame>
        <div className="grid gap-5 md:grid-cols-2">
          {[1, 2].map((index) => (
            ...
            >
              <div className="h-full overflow-hidden rounded-3xl bg-[#1a1a1a]">
                <PlaceholderImage src={gallery[index]} label={`${project.title} ${index + 1}`} className="object-cover" />
              </div>
            </div>
          ))}
        </div>
      ...
      <SectionFrame>
        <div className="grid gap-5 md:grid-cols-2">
          <div className="aspect-[16/9] md:col-span-2">
            <div className="h-full overflow-hidden rounded-3xl bg-[#1a1a1a]">
              <PlaceholderImage src={gallery[3]} label={`${project.title} 4`} className="object-cover" />
            </div>
          </div>
        </div>
      </SectionFrame>
